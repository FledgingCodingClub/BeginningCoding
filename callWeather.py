...
"""
Function: currentTemp(city_code)
Returns the current temp pulled from NOAA as a Float

Exmaple:  LansingTemp = callWeather.currentTemp('KLAN')
"""

def currentTemp(city_code):
    cityWeather = Weather(noaa_city_code=city_code)
